...
GENODE_ROOT=${GENODE_ROOT:-/scratch/b35z/pixelhero.b35z/genode/outputs/verification_gipo_locked_multiaxis_b64_optim_20260607}
...
collect_job=$(sbatch --parsable --dependency=afterok:${additive_report_job}:${adaln_report_job} "${SCRIPT_DIR}/04_collect_b64_optim_summary.sbatch")
