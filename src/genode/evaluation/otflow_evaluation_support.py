...
def evaluate_forecast_schedule(
    ...
    *,
        ...
        encoded_protocol = json.dumps(
            {
                ...
                "policy_kind": None if policy is None else policy.policy_kind,
        ...
        with ProgressBar(len(chunk_starts), str(progress_label), enabled=progress_enabled) as progress:
            for chunk_start in chunk_starts:
                ...
                if return_context_embeddings:
                    ...
                    if context_embedding_width is None:
    ...
    if return_context_embeddings:
        ...
        result["context_embedding_protocol"] = FROZEN_BACKBONE_POLICY_CONTEXT_PROTOCOL
        result["context_embedding_width"] = int(context_embedding_width or 0)
    return result
