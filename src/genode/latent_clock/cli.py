...
def build_parser() -> argparse.ArgumentParser:
    ...
    prepare.add_argument("--student-kind", choices=("deterministic", "stochastic"), default="deterministic")
    ...
    fit.add_argument("--student-kind", choices=("deterministic", "stochastic", "both"))
    ...
    geneval.add_argument("--student-kind", choices=("deterministic", "stochastic"), default="deterministic")
